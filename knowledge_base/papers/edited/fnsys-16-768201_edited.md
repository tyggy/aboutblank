...
(Oudeyer and Kaplan, 2007, 2013; [[Paul Lyon]] and Kuchling, 2021)].
...
scales, while developmental [[Membrane Potential (Vmem)]] changes occur in minutes or
...
dynamics on the electrical synapse ([[Gap Junctions]]) can provide association
between action in one location and reward in another, which
enables the system to support [[Credit Assignment Problem]] at the level of
...
Levin
Mind as It Can Be
TABLE 3 | An example of the [[Cognitive Scaling]].
...
states that can induce [[Dukkha]].
• Bodies consist of components which are themselves competent
([[Teleonomy]] modules that navigate their own spaces) and can achieve
...
• [[Developmental Bioelectricity]] underlie the computations of cell collectives at the
...
[[Gap Junctions]]-coupled neighbor, there are no metadata on that signal
...
event are a kind of [[Confabulation]] for the recipient cell, but a
true memory for the collective network of the stimulus that
occurred in one part of the [[Individuality]]. This wiping of ownership
...
enlarging toward common goals—not by [[Bottom-Up Control]], but
...
[[Teleonomy]]. When individual identities are blurred in
...
expression and carcinogen exposure leads to a closure of [[Gap Junctions]]
...
neighbors the [[David Power]] to change its state. Compatible with the
...
such cell groups without metadata on which cell originated them. The versatile gating of [[Gap Junctions]] synapses allows the formation of multicellular Selves that own memories
of physiological past events at the tissue level (not just [[Individuality]] cells’) and support larger target patterns, enabling them to cooperate to make complex organs (B).
This process can break down: when oncogenes are expressed in tadpoles, [[Membrane Potential (Vmem)]] dye imaging (C) reveals the abnormal [[Membrane Potential (Vmem)]] of cells that are disconnected
...
control as tumors (D). This process can be prevented (Chernet and Levin, 2013a,b; Chernet et al., 2016) by artiﬁcially regulating their [[Membrane Potential (Vmem)]] [e.g.,
...
oncogene [(G), red label]. This illustrates the instructive capacity of [[Developmental Bioelectricity]] to dominate single cell and genetic states to control large-scale tissue
...
another [[Self]] creates an important dimensionality reduction
...
Levin
Mind as It Can Be
interactions, but also the [[Problem Space]] itself. These dynamics
...
to change physiological state. An [[Self]] can notice patterns in
...
can engage in [[Free Energy Principle]] to manage their sensory
experience (Friston
K. et al., 2014; Friston K. J. et al.,
2014; Thornton, 2017). Similarly, [[Individuality]] cells homeostatically
maintain Vmem (cell membrane [[Membrane Potential (Vmem)]] voltage) levels.
However, cells can electrically couple via [[Gap Junctions]] to
create [[Developmental Bioelectricity]] that work as a kind of virtual
...
[[Anatomical Morphospace]] toward the correct [[Homeostatic Setpoint]]
(Sullivan et al., 2016; Levin, 2021a; [[Giovanni Pezzulo]] et al., 2021).
[[Membrane Potential (Vmem)]] is especially interesting because each Vmem level in
...
is applied to the homeostatic TOTE ([[Homeostatic Loops]]) loop,
...
[[Cybernetic Perception-Action Loop]] in which rising multiscale [[Agency]] potentiates the
...
memory,
spatial
[[Integration]], and generalization ([[Coarse-Graining]] over ion channel
...
dynamical systems pictures of artiﬁcial neural networks as they perform [[Downward Causation]] based on partial input illustrate an energy landscape with wells
corresponding to stable [[Homeostatic Setpoint]] memories. The process of completing a correct planarian pattern from a simple fragment can be modeled in this way,
perhaps with overall [[Dukkha]] levels instantiating the free energy that the system is trying to minimize (Kuchling et al., 2020b). Such attractors correspond to different
possible morphologies, and indeed the normally robust regeneration toward a single pattern (D) can be modiﬁed in [[Planarian Regeneration]] by temporarily disrupting their gap
...
world ([[Fred Keijzer]] et al., 2013) is an adaptation built upon the
...
also utilize [[Membrane Potential (Vmem)]] for proliferation control (Stratford
...
patterns, [[Meta-Stability]], and spatial [[Integration]] (Humphries et al.,
2017; Liu et al., 2017; Larkin et al., 2018; Martinez-Corral et al.,
2018; Yang et al., 2020). Not only animal lineages, but plants
([[Francis Baluska]] and Mancuso, 2012; Volkov et al., 2019; Serre et al.,
...
anatomy. Indeed, the KCNH8 ion channel and a [[Gap Junctions]] were
...
electrical information as pre-neural networks ([[Fred Keijzer]], 2015;
...
around a whole embryo (and [[Individuality]] organs) to preprocess
...
1978; [[Giovanni Pezzulo]] and Levin, 2015; Manicka and Levin, 2019b) is
...
Conversely, advances in understanding [[Cognition]]
...
and decision-making networks. For any given [[Self]] (cell,
...
anatomy of the host—like the naïve bacteria on [[Planarian Regeneration]] that
...
travel to regions of [[Problem Space]] that might otherwise be
...
system can reach a speciﬁc [[Homeostatic Setpoint]] (and functionality)
...
related) key implications for the [[David Power]] and speed of evolution.
...
the eye even if it starts out somewhere else. Thus, [[Multi-Scale Competency]] shields
...
lifetime of an [[Individuality]] [as in the inverse relationship between
...
Posfai et al., 2016). By using a [[Downward Causation]] layer to encode
...
Bioelectric pattern memories (such as the [[Membrane Potential (Vmem)]] distribution
...
information encoded in the setpoints, such as the [[Bioelectric Prepattern]]
...
machine learning (indeed, all learning) is [[Credit Assignment Problem]]:
which change or action led to the improvement or reward?
When a collection of cells known as a “rat” learns to press a
level and get a reward, no [[Individuality]] cell has the experience of
...
of actions can be linked to arbitrary rewards). [[Multi-Scale Competency]] does the
same thing for evolutionary learning (Watson et al., 2014, 2016;
[[David Power]] et al., 2015; Watson and [[Eörs Szathmáry]], 2016; Kouvaris et al.,
...
of the evolutionary search process. Much as (Figure 5) an [[Self]]’s
...
(Beggs, 2008; Hankey, 2015). The [[Plasticity]] and [[Teleonomy]]
...
with several views on [[Consciousness]] in compound
...
is fundamentally that of the primacy of [[Teleonomy]].
...
internal [[Self]]-determination and [[Teleonomy]] is apparently
...
magnify the nano-[[Teleonomy]] and indeterminate action
...
amplify it, resulting in scaling up of [[Consciousness]].
...
“What is it like to be” a given [[Self]] (Nagel, 1974). Sensory
augmentation, neural link technologies, and bioengineering
produce tractable model systems in novel cognitive architectures,
such as 2-headed [[Planarian Regeneration]] where the brains are connected by a
...
technological [[Cyborg]] such as brains instrumentized with novel
...
Future, radical [[Neuroprosthetics]] in human patients are
...
and third person perspective (external scientiﬁc study of that [[Self]]) can be seen to also be a gradual continuum, when modern technology is used to
expand [[Heterophenomenology]] (Dennett, 1991). On the left side of the continuum (A) is a traditional 3-rd person scenario of an [[Self]] studying another by measuring
...
example, if the output of a multielectrode array recording neural activity of subject #1 is connected directly to the [[Sensory Substitution And Augmentation]] device (Danilov and Tyler, 2005) of subject
...
can readily induce a state in which all the [[Individuality]] cells are ﬁne
...
Levin
Mind as It Can Be
scaling example above, shutting down [[Bioelectricity]]
among the cells leads to a disappearance of the higher-level
computational layer while the cellular network is disrupted. [[Gap Junctions]]
...
for the brain to return to the correct global [[Membrane Potential (Vmem)]]
...
correct [[Homeostatic Setpoint]] (Emmons-Bell et al., 2015). It is no
...
has to seriously consider [[Gradualism]] in other
organs, tissues, and synthetic constructs that have the same
features neurons and their networks do (Trewavas and [[Francis Baluska]],
...
imagine what properties a truly minimal [[Self]] would have to
...
[[Problem Space]] for intelligent agents, which not only contains
...
multi-scale architecture of life means that we are a [[Self]]
...
tractable model system for [[Basal Cognition]], in which
these processes and the scaling of Selves can not only be seen
but can also be manipulated, is [[Anatomical Homeostasis]].
...
assignment, learning, [[Dukkha]] reduction, etc. The partial wiping
[[Frontiers In Systems Neuroscience]] | www.frontiersin.org
March 2022 | Volume 16 | Article 768201
...
change during the lifetime of the [[Self]]). However, many other
...
2013; Badcock et al., 2019; Ramstead et al., 2019), [[Robert Rosen]]’s (M,R)
and [[Anticipatory Systems]] (Rosen, 1973, 1979, 1985; Nasuto
and Hayashi, 2016), and recent advances in information theory
as applied to [[Individuality]] and scaling of causal [[David Power]] (Hoel
...
of AI platforms based on [[Self]] architectures that do
...
([[Nick Bostrom]], 2015), it is imperative to study the [[Cognitive Scaling]]
...
which optimize the tradeoﬀs needed to maximize [[Individuality]] goals
...
pursue [[Teleonomy]], is central to our notions of moral
...
seriously (Levin and Dennett, 2020). The [[Computational Boundary Of Self]] is not an
...
the [[Self]] abundant in the world.
REFERENCES
...
system,” in ECAL 2017: The 14th European Conference on Artiﬁcial Life ([[Paul Lyon]]:
[[Mit Press]]), 430–437.
...
membrane [[Membrane Potential (Vmem)]] are an early mechanism necessary and suﬃcient to induce
...
long-range [[Gap Junction Signaling]] during development, health, and
...
in Medicine and Biology Society, Vol. 2007 ([[Paul Lyon]]), 2996–2999. doi: 10.1109/
IEMBS.2007.4352959.
...
[[Francis Baluska]], F., and Mancuso, S. (2012). [[Ion Channels]] in plants: from [[Bioelectricity]], via
signaling, to behavioral actions. Plant Signal. Behav. 8:e23009. doi: 10.4161/psb.
Baluska, F., and Reber, A. (2019). [[Consciousness]] and [[Consciousness]] in single cells:
...
RNA from trained aplysia can induce an epigenetic [[Engrams]] for long-term
...
Beer, R. D., and Williams, P. L. (2015). [[Cognition]] and dynamics in
...
random [[Gene Regulatory Networks]]. iScience 24:102131. doi: 10.1016/j.isci.2021.
...
[[Nick Bostrom]], N. (2015). [[Super Intelligence]]: Paths, Dangers, Strategies. Oxford: Oxford
University Press.
...
networks for adaptive [[Teleonomy]]. PLoS Comput. Biol. 4:e1000042.
...
Chernet, B. T., and Levin, M. (2013a). Endogenous [[Membrane Potential (Vmem)]] potentials and the
microenvironment: [[Bioelectrical Signaling]] that reveal, induce and normalize [[Cancer]].
...
Chiu, L., and Gilbert, S. F. (2015). The birth of the [[Self]]: multi-species birthing
...
Danilov, Y., and Tyler, M. (2005). [[Sensory Substitution And Augmentation]]: an alternative input to the brain.
...
Wilson, Paris.
di Primio, F., Muller, B. S., and Lengeler, J. W. (2000). “[[Basal Cognition]]
...
[[Cyborg]]: on the precipice of a drug delivery revolution. Cell Chem. Biol. 25,
...
Dukas, R. (1998). Cognitive Ecology: The [[Evo-Eco]] of Information
...
Elgart, M., Snir, O., and Soen, Y. (2015). [[Dukkha]]-mediated tuning of developmental
...
Ellis, G. F. R., Noble, D., and O’Connor, T. (2012). [[Downward Causation]]: an
...
(2019). Regenerative adaptation to electrochemical perturbation in [[Planarian Regeneration]]: a
...
Fields, C., Hoﬀman, D. D., Prakash, C., and Singh, M. (2017). Conscious [[Self]]
...
Friston, K., Rigoli, F., Ognibene, D., Mathys, C., Fitzgerald, T., and [[Giovanni Pezzulo]], G.
...
Fukumoto, T., Kema, I. P., and Levin, M. (2005b). [[Neurotransmitter]] signaling
...
an early step in left-right patterning in chick and [[Xenopus Development]]. Dev. Neurosci.
...
rstb.2019.0766
Giselbrecht, S., Rapp, B. E., and Niemeyer, C. M. (2013). The chemistry of [[Cyborg]]–
...
Levin
Mind as It Can Be
Gremiaux, A., Yokawa, K., Mancuso, S., and [[Francis Baluska]], F. (2014). Plant anesthesia
...
Theoretical Biology, Vol. 5, eds R. [[Robert Rosen]] and F. Snell (New York, NY: Academic
Press).
...
Harris, M. P. (2021). [[Developmental Bioelectricity]] as a unique regulator of development and
...
Jekely, G., [[Fred Keijzer]], F., and Godfrey-Smith, P. (2015). An [[Problem Space]] for early
...
Keijzer, F., van Duijn, M., and [[Paul Lyon]], P. (2013). What nervous systems do: early
...
spiking in Escherichia coli probed with a ﬂuorescent [[Membrane Potential (Vmem)]]-indicating protein.
...
2019.06.001
Lan, G., and Tu, Y. (2016). [[Cognition]] in bacteria: memory,
...
Law, R., and Levin, M. (2015). Bioelectric memory: modeling [[Membrane Potential (Vmem)]]
...
Levin
Mind as It Can Be
Levin, M. (2019). The [[Individuation]] of a “[[Self]]”: developmental
...
0.077
Levin, M. (2021a). [[Developmental Bioelectricity]]: reprogrammable circuits underlying
...
Levin, M., and Dennett, D. C. (2020). [[Minimal Intelligence]]. Melbourne:
Aeon.
...
Levin, M., [[Fred Keijzer]], F., Lyon, P., and Arendt, D. (2021). Uncovering cognitive
...
Levin, M., [[Giovanni Pezzulo]], G., and Finkelstein, J. M. (2017). Endogenous bioelectric
signaling networks: exploiting [[Membrane Potential (Vmem)]] gradients for control of growth and form.
...
model explains the variability of the [[Homeostatic Setpoint]] in regeneration. J. R.
...
[[Paul Lyon]], P., and Kuchling, F. (2021). Valuing what happens: a biogenic approach
...
Manicka, S., and Harvey, I. (eds) (2008). ‘Psychoanalysis’ of a Minimal [[Self]].
Artiﬁcial Life XI; Winchester, UK.
Manicka, S., and Levin, M. (2019b). The [[Cognitive Lens]]: a primer on conceptual
tools for analysing [[Cognition]] in developmental and regenerative
...
non-neural [[Developmental Bioelectricity]]. Sci. Re.p 9:18612. doi: 10.1038/s41598-01954859-8
...
Mayr, E. (1992). The idea of [[Teleonomy]]. J. Hist. Ideas 53, 117–135. doi: 10.2307/
...
McEwen, B. S. (1998). [[Dukkha]], adaptation, and disease. [[Homeostasis And Homeodynamics]] and allostatic
...
[[Major Transitions In Evolution]]. Integr. Comp. Biol. 43, 64–73. doi:
10.1093/icb/43.1.64
[[Frontiers In Systems Neuroscience]] | www.frontiersin.org
March 2022 | Volume 16 | Article 768201
...
inclusive animal ethics. Anim. [[Consciousness]] 29:2020.
Miller, S. D., and Triggiano, P. J. (1992). The psychophysiological investigation of
[[Dissociative Identity Disorder]] disorder: review and update. Am. J. Clin. Hypn. 35, 47–61.
doi: 10.1080/00029157.1992.10402982
Montgomery, B. A. (2003). [[Consciousness]] and Personhood in [[Commissurotomy]] Patients:
...
[[Membrane Potential (Vmem)]]-gated [[Ion Channels]] at the [[Emergence]] of Metazoa. J. Exp. Biol. 218(Pt. 4),
...
Morgan, T. H. (1904). The control of heteromorphosis in [[Planarian Regeneration]] maculata. Arch.
...
Nagel, E. (1979). [[Teleonomy]] Revisited and Other Essays in the Philosophy and History
...
1468-5930.00141
Nasuto, S. J., and Hayashi, Y. (2016). [[Anticipatory Systems]]: beyond [[Artificial Life]] and
...
science is emerging: the promise of [[Cyborg]]. Adv. Healthc. Mater.
...
Peters, A., McEwen, B. S., and Friston, K. (2017). Uncertainty and [[Dukkha]]: why
it causes diseases and how it is mastered by the brain. Prog. Neurobiol. 156,
164–188. doi: 10.1016/j.pneurobio.2017.05.004
[[Giovanni Pezzulo]], G., and Levin, M. (2015). Re-membering the body: applications of
computational neuroscience to the [[Downward Causation]] of regeneration of limbs
...
Pezzulo, G., Lapalme, J., Durant, F., and Levin, M. (2021). [[Meta-Stability]] of somatic
...
correction of craniofacial defects in pre-metamorphic [[Xenopus Tadpole]] tadpoles
...
Iembs.2003.1280959
[[David Power]], D. A., Watson, R. A., [[Eörs Szathmáry]], E., Mills, R., Powers, S. T., Doncaster,
...
Ion channels enable [[Bioelectricity]] in bacterial communities. Nature
...
[[Variational Ecology]] and the physics of [[Consciousness]]. Phys. Life Rev. 31,
...
00892-1
Reber, A. S., and [[Francis Baluska]], F. (2021). Cognition in some surprising places. Biochem.
...
[[Robert Rosen]], R. (1973). Dynamical realization of (M,R)-Systems. Bull. Math. Biol. 35, 1–9.
...
Schulkin, J., and Sterling, P. (2019). [[Homeostasis And Homeodynamics]]: a brain-centered, predictive mode of
...
Sheiman, I. M., and Tiras, K. L. (1996). “Memory and [[Morphogenesis]] in [[Planarian Regeneration]]
...
Szilagyi, A., Szabo, P., Santos, M., and [[Eörs Szathmáry]], E. (2020). Phenotypes to
...
Trewavas, A. J., and [[Francis Baluska]], F. (2011). The ubiquity of [[Consciousness]]. EMBO Rep.
...
Watson, R. A., Buckley, C. L., [[Richard Mills]], R., and Davies, A. (eds) (2010). “Associative
...
[[Evolutionary Transitions In Individuality (Etis)]]. Proc. Natl. Acad. Sci. U.S.A. 112, 10112–10119.
...
s0269889708001919
Xue, Y., and Acar, M. (2018). Mechanisms for the [[Epigenetic Inheritance]] of [[Dukkha]]
...
it or to think about it (Nagel, 1974). Consciousness here is not meant to necessarily indicate advanced, reﬂexive, verbal selfconsciousness but rather the basal [[Consciousness]] (sense-process-respond loop) which is taken to be a continuum. Moreover, because
...
Components include [[Active Inference]], learning, and basal [[Teleonomy]], as well as complex cognitive skills such as
...
inputs (stimuli) to a system is whatever scale is most eﬃcient for understanding the resulting decisions (Noble, 2012; [[Giovanni Pezzulo]]
...
of [[Self-Model]] of the Self and its outside world ([[Self-Model]]), anxiety, and creativity (identifying opportunities,
...
by recognizing that there is no intelligent [[Self]] that is not made of parts, [[Collective Intelligence]] is generalized here (emphasizing
...
[[Integration]] and the modulation of higher levels by the level of [[Dukkha]] in subunits.
...
to any [[Individuality]] sub-component. Selves are deﬁned by the spatio-temporal scale and nature of the types of goals they can
...
as activity gets the system closer to its desired region of [[Problem Space]]). The spatio-temporal and complexity scale of events that
...
an [[Self]], either within or across levels of organization. Thus, geometric frustration (Sadoc and Mosseri, 2007) and material
scientists’ notions of [[Dukkha]] as a high-level determinant of system behavior over time (Batterman and Rice, 2014; Batterman, 2015)
